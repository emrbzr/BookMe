  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button id="closeTimer" type="button" class="close" data-dismiss="modal">&times;</button>
        <h2 class="modal-title text-center"><span style="color: #93DC69;">Room 2</span></h2>
      </div>
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-md-2 col-md-offset-5">
            <button type="button" class="killer btn btn-default" data-dismiss="modal">Submit</button>
          </div>
        </div>
      </div>
    </div>
